<?php
	...
	if(isset($_POST['save'])){
		...
		$mysqli->query("CALL end_hospital('$latitude', '$longitude', '$logradouro', '$bairro', $municipio_cod, '$cod')") or die(mysqli_error($mysqli));



		header("location: enderecoHospital.php");
	...
	if (isset($_GET['delete'])) {
		...
		$mysqli->query("UPDATE HOSPITAL SET hospital_endereco_id = null WHERE hospital_endereco_id = $id") or die(mysqli_error($mysqli));
